...
{
    public partial class Goods_Delivery_Details : Form
    {
        public Goods_Delivery_Details()
        {
            InitializeComponent();
        }
        ...
        {
            String deliveryId = LabelID;
            SqlConnection conn = new SqlConnection();
            conn.ConnectionString = ConfigurationManager.ConnectionStrings["DBConnectionString"].ConnectionString;
            conn.Open();

            SqlCommand cmd = new SqlCommand($"SELECT * FROM Goods_Delivery_Details WHERE deliveryId ='{deliveryId}'", conn);
        ...
        private void Goods_Delivery_Details_FormClosing(object sender, FormClosingEventArgs e)
        {
            try
            {
        ...
        private void Goods_Delivery_Details_Load(object sender, EventArgs e)
        {
            ProductLoad();
